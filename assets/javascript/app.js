...
var questions = [
  ...
  question: "If Harrison Ford had not been cast as Han Solo, George Lucas's next choice was Christopher Walken.",
  answer: ["True", "False"],
  name: "hanSolo",
  correct: "True",
  divClass: ".hanSolo"
...
function checkAnswers() {
  ...
  for (var i = 0; i < 10; i++) {
    if ($('input:radio[name="' + thisQuestion.name + '"]:checked').val() === thisQuestion.correct)
      { correctAnswers++; }
    else
      { incorrectAnswers++; };
  }
